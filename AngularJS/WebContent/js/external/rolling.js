(function(h, f, c, j, d, l, k) {/* ! Jssor */
	...
	var b = new function() {
		var g = this, Bb = /\S+/g, G = 1, db = 2, hb = 3, gb = 4, lb = 5, H, r = 0, i = 0, s = 0, W = 0, z = 0, J = navigator, pb = J.appName, o = J.userAgent, p = parseFloat;
		function zb() {
			if (!H) {
				H = {
					Pe : "ontouchstart" in h || "createTouch" in f
				};
				var a;
		...
		g.Kb = sb;
		function Z(a) {
			a.constructor === Z.caller && a.Ad
					&& a.Ad.apply(a, Z.caller.arguments)
		}
		g.Ad = Z;
		g.zb = function(a) {
			if (g.lf(a))
		...
		g.xc = m("transformOrigin", 4);
		g.ef = m("backfaceVisibility", 4);
		g.Zd = m("transformStyle", 4);
		g.df = m("perspective", 6);
		g.cf = m("perspectiveOrigin", 4);
		g.bf = function(a, b) {
			if (q() && s < 9 || s < 10 && R())
				a.style.zoom = b == 1 ? "" : b;
			else {
		...
		g.Vd = function(d, a) {
			if (a)
				d.style.clip = "rect(" + c.round(a.g) + "px " + c.round(a.m)
						+ "px " + c.round(a.p) + "px " + c.round(a.f) + "px)";
			else {
		...
		function w(f, l) {
			...
			function i(b, d, a) {
				var e = b.hb(u(-d / 2, -a / 2)), f = b.hb(u(d / 2, -a / 2)), g = b
						.hb(u(d / 2, a / 2)), h = b.hb(u(-d / 2, a / 2));
				b.hb(u(300, 300));
			...
			function a(d, a) {
				a = a || {};
				var f = a.W || 0, l = (a.T || 0) % 360, m = (a.S || 0) % 360, o = (a.E || 0) % 360, p = a.xf;
				if (e) {
					f = 0;
					l = 0;
					m = 0;
		...
		g.zd = function(l, m, w, n, y, z, o) {
			...
			if (m.c && o.eb) {
				var p = a.c.Hb, s = (p.g || 0) + (p.p || 0), r = (p.f || 0)
						+ (p.m || 0);
				a.f = (a.f || 0) + r;
				a.g = (a.g || 0) + s;
				a.c.f -= r;
			...
			if (a.c && b.Ud() && !a.c.g && !a.c.f && a.c.m == o.bb
					&& a.c.p == o.kb)
				a.c = j;
			return a
		}
	...
	function n() {
		...
		a.wb = a.addEventListener = i;
		a.removeEventListener = g;
		a.i = function(a) {
			var c = [].slice.call(arguments, 1);
			b.e(d, function(b) {
				b.sc == a && b.pc.apply(h, c)
			})
		}
	}
	var m = function(z, C, i, J, M, L) {
		...
		function I() {
			if (q) {
				var d = b.R(), e = c.min(d - A, i.Cc), a = g + e * o;
				A = d;
				if (a * o >= n * o)
					a = n;
				t(a);
	...
	var p = new function() {
		...
		var f = this, u, g, a, x = 0, w = t.se, r, h = 8;
		function i(g, f) {
			var a = {
				U : f,
				ac : 1,
		...
		function o(B, h, a, w, o, m) {
			var z = this, u, v = {}, i = {}, n = [], f, e, s, q = a.Gc.Qe || 0, r = a.Gc.Ue || 0, g = a
					.ff(o, m), p = C(a), D = p.length - 1, t = a.ac + a.Kb * D, x = w
					+ t, k = a.Sb, y;
			x += 50;
			function C(a) {
				var b = a.ae(a);
			...
			b.vb(h, j);
			if (b.cb()) {
				var E = !h["no-image"], A = b.Se(h);
				b.e(A, function(a) {
					(E || a["jssor-slider"]) && b.ub(a, b.ub(a), d)
				})
			}
			b
					.e(
		...
		f.of = function(w, x, l, m, b) {
			r = b;
			b = i(b, h);
			var j = m.td, e = l.td;
			j["no-image"] = !m.Zb;
			e["no-image"] = !l.Zb;
			var n = j, p = e, v = b, d = b.Xb || i({}, h);
			if (!b.Sb) {
				n = e;
				p = j
			}
			var t = d.Nb || 0;
			g = new o(k, p, d, c.max(t - d.U, 0), s, q);
			a = new o(k, n, v, c.max(d.U - t, 0), s, q);
			g.Fb(0);
			a.Fb(0);
			u = c.max(g.Pc, a.Pc);
			f.ib = w
		...
		function Bc() {
			...
			m.call(a, -1e8, 2e8);
			a.Ne = function() {
				var b = a.rb(), d = c.floor(b), f = t(d), e = b - c.floor(b);
				return {
					ib : f,
					Me : d,
					pb : e
		...
		function xc(o, f) {
			...
			function E(a) {
				...
				T(o, a, 0);
				F = d;
				q = new I.G(o, I, b.Qd(b.j(o, "idle")) || lc);
				q.N(0)
			}
			function Z() {
				q.oc < I.oc && E()
				...
				if (y.length && !G) {
					...
					if (!W) {
						...
						b.e(y, function(a) {
							if (!b.v(a, "src")) {
								a.src = b.j(a, "src2");
								b.Q(a, a["display-origin"])
							}
						})
					}
					b.Md(y, k, b.L(j, M, c, a))
				} else
					M(c, a)
			};
			e.be = function() {
		...
		function vc(y, f, p, q) {
			...
			a.ie = function() {
				A && A.ib == f && A.tb();
				var b = a.rb();
				b < c && g.i(i.dd, f, -b - 1, n, j, e, c)
			};
			a.Xc = function(a) {
				p && b.ob(jb, a && p.Zc.vf ? "" : "hidden")
			};
			a.dc = function(b, a) {
				if (k && a >= h) {
					k = l;
				...
				g.i(i.Ke, f, a, n, j, e, c)
			};
			a.bd = function(a) {
				if (a && !t) {
					t = a;
					a.wb($JssorPlayer$.Ed, x)
				}
			};
			p && a.hc(p);
			h = a.cc();
		...
		if (a.Be != k)
			a.wc = a.Be;
		var eb = a.ic & 3, tc = (a.ic & 4) / -4 || 1, kb = a.Fe, I = b.B({
			G : q,
			xb : a.xb
		}, a.rf);
		I.yb = I.yb || I.sf;
		var Fb = a.Ae, Z = a.ze, db = a.tf, R = !a.De, y, v = b.z(p, "slides",
				R), fb = b.z(p, "loading", R) || b.Mb(f), Nb = b.z(p,
				"navigator", R), dc = b.z(p, "arrowleft", R), ac = b.z(p,
				"arrowright", R), Lb = b.z(p, "thumbnavigator", R), oc = b.k(v), mc = b
				.l(v), V, Q = [], uc = b.Ib(v);
		b.e(uc, function(a) {
		...
		var s = -1, wb, sb, r = Q.length, K = a.ye || oc, J = a.xe || mc, Wb = a.Ac, zb = K
				+ Wb, Ab = J + Wb, bc = eb & 1 ? zb : Ab, u = c.min(a.s, r), jb, x, O, yb, T = [], Qb, Sb, Ob, cc, Cc, N, E = a.uc, lc = a.yc, Vb = a.bc, qb, tb, ib, Rb = u < r, D = Rb ? a.Qb
				: 0, X, P, F = 1, M, B, S, ub = 0, vb = 0, H, gb, hb, Cb, w, U, z, Tb = new pc, Y, Mb = [];
		if (a.xb)
			Kb = function(a, c, d) {
				b.vb(a, {
					db : c,
		...
		if (kb) {
			cc = kb.uf;
			qb = kb.G;
			tb = u == 1 && r > 1 && qb && (!b.ld() || b.wd() >= 8)
		}
		ib = tb || u >= r || !(D & 1) ? 0 : a.wc;
		X = (u > 1 || ib ? eb : -1) & a.Bc;
		var Gb = v, C = [], A, L, Db = b.gf(), mb = Db.Pe, G, pb, Ib, rb;
		...
		Eb(W());
		b.a(v, "click", jc);
		b.a(p, "mouseout", b.Rb(hc, p));
		b.a(p, "mouseover", b.Rb(Ec, p));
		xb();
		a.qc && b.a(f, "keydown", function(b) {
			if (b.keyCode == 37)
				ob(-a.qc);
			else
				b.keyCode == 39 && ob(a.qc)
		});
		var nb = a.rc;
		if (!(D & 1))
	...
	var o = {
		...
		f.ec = function(D) {
			if (!u) {
				...
				for (var f = 0; f < s; f++) {
					var C = b.Hd();
					b.Xe(C, f + 1);
					var l = b.Ld(g, "numbertemplate", C, d);
					b.u(l, "absolute");
					var v = f % (n + 1);
					b.I(l, !h ? o * v : f % i * o);
					...
					b.J(e, l);
					B[f] = l;
					a.lc & 1 && b.a(l, "click", b.L(j, t, f));
					a.lc & 2 && b.a(l, "mouseover", b.Rb(b.L(j, t, f), l));
					y[f] = b.Tb(l)
				}
				u = d
			}
		...
		x = a.Oc;
		h = a.Mc - 1;
		a.kc == l && b.v(e, "noscale", d);
		a.qb && b.v(e, "autocenter", a.qb)
	}, t = function(a, g, h) {
		var c = this;
		n.call(c);
		var r, q, e, f, i;
		...
		c.ec = function(c) {
			...
			e = 0;
			if (!m) {
				b.a(a, "click", b.L(j, k, -i));
				b.a(g, "click", b.L(j, k, i));
				b.Tb(a);
				b.Tb(g);
				m = d
			}
		...
		if (f.qb) {
			b.v(a, "autocenter", f.qb);
			b.v(g, "autocenter", f.qb)
		}
	};
	function q(e, d, c) {
		var a = this;
	...
	jssor_1_slider_init = function() {
		...
		function a() {
			var b = e.fb.parentNode.clientWidth;
			if (b) {
				b = c.min(b, 600);
				e.Ee(b)
			} else
